...
import app.back.dto.AutoGeneratedEntity;
...
@Transactional
public abstract class BasicDtoTestService<T extends AutoGeneratedEntity, S extends DtoAbstractEntityService<T, ? extends AbstractEntityRepository<T>>> {
